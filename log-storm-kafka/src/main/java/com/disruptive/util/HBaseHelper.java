...
public class HBaseHelper {
    ...
    static {
        ...
        conf.set("hbase.zookeeper.master", PropertiesUtil.getPropertyString("hbase.zookeeper.master"));
        conf.set("zookeeper.znode.parent", PropertiesUtil.getPropertyString("zookeeper.znode.parent"));
        try {
