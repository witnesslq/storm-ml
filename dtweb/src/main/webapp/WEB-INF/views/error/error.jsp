...
<body>
	<div class="login_div_box">
        ...
        <div class="login_div_mid">
        	<div class="titDiv"><span class="t1" style="margin-left: -17px;margin-top: -8px"><img src="${ctx}/front/images/logo_s.png" width="260px" height="50px"/></span><!-- <span class="t2">呼叫中心管理系统登录</span> --></div>
