 ...
 */
@Embeddable
public class AssetProjectsDevelopersRelationId implements java.io.Serializable {
	...
	/** default constructor */
	public AssetProjectsDevelopersRelationId() {
	}

	/** full constructor */
	public AssetProjectsDevelopersRelationId(Integer accountId,
			Integer projectId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AssetProjectsDevelopersRelationId))
			return false;
		AssetProjectsDevelopersRelationId castOther = (AssetProjectsDevelopersRelationId) other;
