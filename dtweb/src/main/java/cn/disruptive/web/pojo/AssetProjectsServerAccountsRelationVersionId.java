 ...
 */
@Embeddable
public class AssetProjectsServerAccountsRelationVersionId implements java.io.Serializable {
	...
	/** default constructor */
	public AssetProjectsServerAccountsRelationVersionId() {
	}

	/** full constructor */
	public AssetProjectsServerAccountsRelationVersionId(Integer accountId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AssetProjectsServerAccountsRelationVersionId))
			return false;
		AssetProjectsServerAccountsRelationVersionId castOther = (AssetProjectsServerAccountsRelationVersionId) other;
