 ...
 */
@Embeddable
public class AssetProjectsTestersRelationVersionId implements
	...
	/** default constructor */
	public AssetProjectsTestersRelationVersionId() {
	}

	/** full constructor */
	public AssetProjectsTestersRelationVersionId(Integer accountId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AssetProjectsTestersRelationVersionId))
			return false;
		AssetProjectsTestersRelationVersionId castOther = (AssetProjectsTestersRelationVersionId) other;
