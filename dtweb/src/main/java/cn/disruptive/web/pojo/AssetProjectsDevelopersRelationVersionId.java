 ...
 */
@Embeddable
public class AssetProjectsDevelopersRelationVersionId implements java.io.Serializable {
	...
	/** default constructor */
	public AssetProjectsDevelopersRelationVersionId() {
	}

	/** full constructor */
	public AssetProjectsDevelopersRelationVersionId(Integer accountId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AssetProjectsDevelopersRelationVersionId))
			return false;
		AssetProjectsDevelopersRelationVersionId castOther = (AssetProjectsDevelopersRelationVersionId) other;
