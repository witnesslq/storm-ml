 ...
 * Data：		2015年9月21日
 */
public class BizTrackNoInfoVO implements Comparable {
	...
	public Integer getSumTimeOut() {
		return sumTimeOut;
	}

	public void setSumTimeOut(Integer sumTimeOut) {
		this.sumTimeOut = sumTimeOut;
	}

	@Override
	public int compareTo(Object o) {
		return (int) (this.getTimeMillis() - ((BizTrackNoInfoVO) o).getTimeMillis());
	}
