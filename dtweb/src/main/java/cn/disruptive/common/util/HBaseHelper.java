...
public class HBaseHelper {
    ...
    static {
        ...
        conf.set("hbase.zookeeper.quorum",
        		ReadConfigation.getConfigItem("hbase.zookeeper.quorum"));
        conf.set("hbase.zookeeper.property.clientPort",
        		ReadConfigation.getConfigItem("hbase.zookeeper.property.clientPort"));
        conf.set("hbase.zookeeper.master", ReadConfigation.getConfigItem("hbase.zookeeper.master"));
        conf.set("zookeeper.znode.parent", ReadConfigation.getConfigItem("zookeeper.znode.parent"));
        try {
    ...
    public static List<Map<String,String>> scanByPrefixFilter(String tableName,String rowPrifix) throws IOException{
    	 HTableInterface table = null;
    	 table = getTable(tableName);
         List<byte[]> rowKeyList = new LinkedList<byte[]>();
         List<Map<String, String>> result = new LinkedList<Map<String, String>>();
...
/*    	List<Map<String,String>> lis=HBaseHelper.scanByPrefixFilter("sys_business_no_request_log", "2015-09-16 10:35:47.102");
        ...
        List<Map<String, String>> ls = scanByPage(name,"1442543983601","1442545712760",1,null);
    ...
    public static Map<String, Integer> saveListMap(String tableName, List<Map<String, String>> lists) {
        ...
        for (Map<String, String> map : lists) {
            ...
            for (String key : keySet) {
                ...
                put.add("t1".getBytes(), key.getBytes(), Bytes.toBytes(map.get(key)));
            }
