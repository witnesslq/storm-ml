...
package com.dis.hbase.indexer.netty.util;
...
public class NettyUtils {
  ...
  public static EventLoopGroup createEventLoop(IOMode mode, int numThreads, String threadPrefix) {
    ...
    switch (mode) {
      ...
      case EPOLL:
    	return new EpollEventLoopGroup(numThreads, Executors.newCachedThreadPool(threadFactory));
  ...
  // new PooledByteBufAllocator(preferDirect, nHeapArena, nDirectArena, pageSize, maxOrder)
